...
server <- function(input,output,sessions) {
  ...
  output$myMap <- renderLeaflet({
    ...
    if (population_type == "2016 population by area") {
      
      # define bins
      bins <- c(0, 1000, 5000, 6000, 7000, 8000, 9000, 10000, 15000, 20000, 25000, 30000, 35000, 40000, 45000, 50000, Inf)
    ...
    } else if (population_type == "2016 vs 2006 population change") {
      
      # define bins
      bins <- c(-Inf, -20, -10, -5, -1, -0.5, 0, 1, 5, 7, 9, 10, 15, 20, 25, 30, 50, Inf)
